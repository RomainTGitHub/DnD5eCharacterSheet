...
const classFeatures = {
    "Barbare": {
        1: [
            ...
            { name: "Bottes d'Arme", description: "Votre entraînement martial vous permet de recourir à la botte de deux types d'arme de corps à corps courante ou de guerre de votre choix, par exemple la hache à deux mains et la hachette. <br> Chaque fois que vous terminez un Repos long, vous pouvez accomplir des exercices martiaux pour changer l'un de ces choix. <br> Lorsque vous atteignez certains niveaux de Barbare, vous recevez la faculté de recourir à la botte d'autres types d'arme." }
